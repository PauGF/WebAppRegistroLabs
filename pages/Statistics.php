        ...
        <main>
            <div class="content">
                ...
                <div class="content-right">
                    ...
                    <div class="center div-btn-report">
                        <form>
                             <button class="btn waves-effect waves-light" type="submit" name="action">Descargar reporte<i class="material-icons right">insert_chart</i></button>
                        </form>
                    </div>
                </div> 
            </div>
